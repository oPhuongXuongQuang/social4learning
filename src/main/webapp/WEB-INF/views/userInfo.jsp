                            ...
                            <div class="col-md-3 col-sm-4">
                                <div class="pagetitle">
                                    <div id="item-header" role="complementary">
                                        ...
                                        <div id="item-header-content">
                                            <h3>
                                                <a href="index.html">${USER.firstname} ${USER.lastname}</a>
                                            </h3>
                                            <div class="location">
                                                ${USER.address}
                                            </div>
                                ...
                                <div id="item-nav" class="">
                                    <div class="item-list-tabs no-ajax" id="object-nav" role="navigation">
                                        <ul>
                                            <li id="xprofile-personal-li" class="current selected"><a id="user-xprofile" href="profile/index.html">Profile</a></li>
                                            <li id="forums-personal-li"><a id="user-forums" href="forums/index.html">Notification<span class="no-count">Number of noti</span></a> </li>
                                           
                                            <li id="forums-personal-li"><a id="user-forums" href="forums/index.html">Enrolled courses</a></li>
                                            <li id="forums-personal-li"><a id="user-forums" href="forums/index.html">Course access<span class="no-count">Number of noti</span></a></li>
                                            <li id="forums-personal-li"><a id="user-forums" href="forums/index.html">Message <span class="no-count">Number of message</span></a></li>
                                            <li id="activity-personal-li"><a id="user-activity" href="#">Activity</a></li>
                                            <li id="friends-personal-li">
                                                <a id="user-friends" href="friends/index.html">
                                                    Friends
                                                    <span class="no-count">Number of friends</span>
                                                </a>
                                            </li>
